"""Prebuilt state schemas for monet's default planning/execution/chat graphs.

Core utilities (``_append_reducer``, ``AgentInvocationResult``) live in
:mod:`monet.orchestration._state`. Custom graphs may reuse them without
depending on these prebuilt schemas.
"""
...
class ExecutionState(TypedDict, total=False):
    ...
    compatible with ``AgentInvocationResult``).
    """
