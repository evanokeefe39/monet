"""Reference QA agent — content quality evaluation with signal emission.

Evaluates free-text artifacts against a task brief. For comparative
trial-scorecard evaluation (baseline + ranking), use the ``evaluator``
agent instead.
"""
