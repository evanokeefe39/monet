...
Top-level dirs:
- `src/monet/` — package source (src layout): `events/`, `config/`, `core/`, `cli/`, `client/`, `hooks/`, `progress/`, `queue/`, `worker/`, `orchestration/`, `server/`, `agents/`, `artifacts/`, `schedule/`, `_migrations/`
